...
wd_tur <- "C:/Users/ca13kute/Documents/2nd_Chapter/Spiders/TUR_adm"
...
reg_i <- shp_ants[grep("Society",shp_ants$BENTITY2_N),]
...
i=340 ### region taken from ants shapefile, attribute table must be modified
########## to include the feature in the shp
...
i=341 ### region taken from ants shapefile, attribute table must be modified
########## to include the feature in the shp
...
i=342 ### region taken from ants shapefile, attribute table must be modified
########## to include the feature in the shp
...
i=343 ### region taken from ants shapefile, attribute table must be modified
########## to include the feature in the shp
...
i=344 ### region taken from ants shapefile, attribute table must be modified
########## to include the feature in the shp
...
i=345 ##### Russia is divided in a very unorthodox way 
##### Deal with it manually...
...
i=346 ### region taken from ants shapefile, attribute table must be modified
########## to include the feature in the shp
...
i=347 #### region taken from GRIIS shapefile, attribute table must be modified
########## to include the feature in the shp
...
regions[i] %in% griis_regs
grep("Solomon",griis_regs)

reg_i <- shp_griis[grep("Solomon",shp_griis$Region),]
...
i=348 ### region taken from ants shapefile, attribute table must be modified
########## to include the feature in the shp
...
i=349 ### region taken from ants shapefile, attribute table must be modified
########## to include the feature in the shp
...
i=350 #### region taken from GRIIS shapefile, attribute table must be modified
########## to include the feature in the shp

# Manually separate St Helena from Ascension, and Tristan da Cunha
...
#cut the island
b <- as(extent(-5.82, -5.61, -16, -15.88), 'SpatialPolygons')
reg_i <- crop(reg_i,b)
...
i=351 #### region taken from GRIIS shapefile, attribute table must be modified
########## to include the feature in the shp
...
regions[i] %in% griis_regs
grep("Kitts",griis_regs)

reg_i <- shp_griis[grep("Kitts",shp_griis$Region),]
...
i=352 #### region taken from GRIIS shapefile, attribute table must be modified
########## to include the feature in the shp
...
regions[i] %in% griis_regs
grep("Lucia",griis_regs)

reg_i <- shp_griis[grep("Lucia",shp_griis$Region),]
...
i=353 #### region taken from GRIIS shapefile, attribute table must be modified
########## to include the feature in the shp
...
regions[i] %in% griis_regs
grep("Vincent",griis_regs)

reg_i <- shp_griis[grep("Vincent",shp_griis$Region),]
...
i=354 ### region taken from ants shapefile, attribute table must be modified
########## to include the feature in the shp
...
i=355 ### region taken from ants shapefile, attribute table must be modified
########## to include the feature in the shp
...
i=356 ### region taken from ants shapefile, attribute table must be modified
########## to include the feature in the shp
...
i=357 ### region taken from ants shapefile, attribute table must be modified
########## to include the feature in the shp
...
i=358 ### region taken from ants shapefile, attribute table must be modified
########## to include the feature in the shp
...
i=359  ### region taken from ants shapefile, attribute table must be modified
########## to include the feature in the shp
...
i=360 ### region taken from ants shapefile, attribute table must be modified
########## to include the feature in the shp
...
i=361 ### region taken from ants shapefile, attribute table must be modified
########## to include the feature in the shp
...
i=362 ### region taken from ants shapefile, attribute table must be modified
########## to include the feature in the shp
...
i=363 ### region taken from ants shapefile, attribute table must be modified
########## to include the feature in the shp
...
i=364 ### wrong name for Tamil Nadu
...
table2$SpiderRegion[which(table2$X.8 == regions[i])] <- "Tamil Nadu"
...
i=365 ### region taken from ants shapefile, attribute table must be modified
########## to include the feature in the shp
...
i=366 #region in Chile (special shapefile)
...
i=367 ### region taken from ants shapefile, attribute table must be modified
########## to include the feature in the shp
...
i=368 ### region taken from ants shapefile, attribute table must be modified
########## to include the feature in the shp
...
reg_i <- shp_ants[grep("Chad",shp_ants$BENTITY2_N),]
...
i=369 ### region taken from ants shapefile, attribute table must be modified
########## to include the feature in the shp
...
i=370 ### region taken from ants shapefile, attribute table must be modified
########## to include the feature in the shp
...
i=371 ### region taken from ants shapefile, attribute table must be modified
########## to include the feature in the shp
...
i=372 ### region taken from ants shapefile, attribute table must be modified
########## to include the feature in the shp
...
i=373 ### region taken from ants shapefile, attribute table must be modified
########## to include the feature in the shp
...
i=374 ### region taken from ants shapefile, attribute table must be modified
########## to include the feature in the shp
...
i=375 ### region taken from ants shapefile, attribute table must be modified
########## to include the feature in the shp
...
i=376 #colonial region in south africa, does not correspond to current borders
# one entry lost


i=377 ### region taken from ants shapefile, attribute table must be modified
########## to include the feature in the shp
...
grep("Trinidad",ant_regs)

reg_i <- shp_ants[grep("Trinidad",shp_ants$BENTITY2_N),]
...
i=378  ### French Polynesia island groups
...
reg_i <- shp_pyf[grep("Tuamotu",shp_pyf$NAME_1),]
...
i=379 ### French Polynesia island groups

### Tubuai is one of the Îles Australes
...
reg_i <- shp_pyf[grep("Australes",shp_pyf$NAME_1),]
...
table2$SpiderRegion[which(table2$X.8 == regions[i])] <- "Iles Australes"
...
i=380 ### region taken from ants shapefile, attribute table must be modified
########## to include the feature in the shp
...
i=381 ### region taken from ants shapefile, attribute table must be modified
########## to include the feature in the shp
...
grep("Tunisia",ant_regs)

reg_i <- shp_ants[grep("Tunisia",shp_ants$BENTITY2_N),]
...
table2$SpiderRegion[which(table2$X.8 == regions[i])] <- "Tunisia"
...
i=382 #same region Tunesia == Tunisia
...
i=383 ### seems to represent only the anatolian part of Turkey
#next entry is "Turkey in Europe"
...
reg_i <- readOGR("Tur_asia",dsn = wd_tur)
...
i=384 ### represents only the european part of Turkey
...
reg_i <- readOGR("TUR_europe",dsn = wd_tur)
...
i=385 ### region taken from ants shapefile, attribute table must be modified
########## to include the feature in the shp
...
i=386 ### region taken from ants shapefile, attribute table must be modified
########## to include the feature in the shp
...
i=387 ### region taken from ants shapefile, attribute table must be modified
########## to include the feature in the shp
...
i=388 ### region taken from ants shapefile, attribute table must be modified
########## to include the feature in the shp
...
i=389 ### region taken from ants shapefile, attribute table must be modified
########## to include the feature in the shp
...
i=390 ### region taken from ants shapefile, attribute table must be modified
########## to include the feature in the shp
