...
wd_list <- "/gpfs1/data/idiv_meyer/01_projects/eduardo/2nd_chapter/GloNAF_data/GLONAF"
wd_out <- "/gpfs1/data/idiv_meyer/01_projects/eduardo/2nd_chapter/GloNAF_data/GBIF_selected_points"

setwd(wd_list)
list <- read.csv("Taxon_x_List_GloNAF_vanKleunenetal2018Ecology_comma.csv")

# create a sps_list

sps_list <- unique(list$standardized_name)
...
selectRecords(list = sps_list, wd.out = wd_out, file="GloNAF_GBIF_occurrences",
